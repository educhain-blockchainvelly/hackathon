...
const FeatureCard: React.FC<FeatureCardProps> = ({ iconPath, title, description, status }) => {
    const statusColors: Record<string, string> = {
        'Not Started': 'text-red-500', 'In Progress': 'text-green-500', 'Done': 'text-blue-600',
    };
    return (
        <div className="bg-gradient-to-br from-indigo-400 to-purple-400 rounded-lg p-6 flex flex-col items-center justify-center shadow-md w-[300px] h-[230px]">
