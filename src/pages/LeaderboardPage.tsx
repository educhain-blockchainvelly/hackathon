...
const SocialPage = () => {
    const rankings = [
        { rank: '#1', user: 'EDU', syncfimon: '🦊', inventory: '30.343 ETH' },
        { rank: '#2', user: 'ARB', syncfimon: '🐻', inventory: '29.138 ETH' },
        { rank: '#3', user: 'ETH', syncfimon: '🐶', inventory: '27.801 ETH' },
        { rank: '#4', user: 'USDC', syncfimon: '🐼', inventory: '26.79 ETH' },
        { rank: '#5', user: 'BTC', syncfimon: '🐝', inventory: '20.89 ETH' },
        { rank: '#6', user: 'USDT', syncfimon: '🐷', inventory: '20.276 ETH' },
        { rank: '#7', user: 'SOL', syncfimon: '🐶', inventory: '19.801 ETH' },
        { rank: '#8', user: 'LINK', syncfimon: '🐼', inventory: '16.79 ETH' },
        { rank: '#9', user: 'DAI', syncfimon: '🐝', inventory: '10.89 ETH' },
        { rank: '#10', user: 'DOGE', syncfimon: '🐷', inventory: '0.276 ETH' },
    ];
