                ...
                <div className="grid grid-cols-2 gap-10 w-full max-w-6xl">
                    ...
                    <div className="bg-gray-100 rounded-lg h-80 flex flex-col justify-center">
                        <form className="flex flex-col space-y-4 px-4">
                            <button className="bg-white text-purple-700 h-14 py-2 px-6 rounded-2xl shadow-md text-left">
                            MY PROFILE
                            </button>
                            <button className="bg-white text-purple-700 h-14 py-2 px-6 rounded-2xl shadow-md text-left">
                            GROUP
                            ...
                            <button className="bg-purple-700 text-white py-2 px-6 rounded-full shadow-md">
                            Sign In
                            </button>
                        </form>
                    </div>
                    ...
                    {/* 카드 2 */}
                    <div className="bg-gradient-to-b from-blue-200 to-yellow-200 rounded-lg h-80"></div>
